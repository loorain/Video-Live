...
public final class ToastUtils {
    ...
    public static void setView(@LayoutRes final int layoutId) {
        LayoutInflater inflate = (LayoutInflater) LiveApp.sInstance.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(LiveApp.sInstance.getResources().getText(resId).toString(), duration);
    }
    ...
    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(LiveApp.sInstance.getResources().getString(resId), args), duration);
    }
    ...
    private static void show(final CharSequence text, final int duration) {
        ...
        if (sViewWeakReference != null) {
            final View view = sViewWeakReference.get();
            if (view != null) {
                sToast = new Toast(LiveApp.sInstance);
                sToast.setView(view);
        ...
        if (!isCustom) {
            if (messageColor != DEFAULT_COLOR) {
                ...
                sToast = Toast.makeText(LiveApp.sInstance, spannableString, duration);
            } else {
                sToast = Toast.makeText(LiveApp.sInstance, text, duration);
            }
        }
